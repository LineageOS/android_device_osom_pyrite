...
DEVICE_PATH := device/osom/pyrite
...
# Asserts
TARGET_OTA_ASSERT_DEVICE := pyrite
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := pyrite
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := $(shell echo $$(($(BOARD_SUPER_PARTITION_SIZE) - 4194304))) # (BOARD_SUPER_PARTITION_SIZE - "reasonable overhead of 4 MiB" 4194304)
...
BOOT_SECURITY_PATCH := 2022-03-05
...
include vendor/osom/pyrite/BoardConfigVendor.mk
